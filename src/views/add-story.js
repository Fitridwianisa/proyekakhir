...
import { StoryDB } from '../utils/indexeddb.js'; // perbaiki path .src jadi ../ jika perlu
...
export function renderAddStory() {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            // Panggil metode uploadStory dari presenter
            await presenter.uploadStoryData({
            ...
            alert('Gagal mengunggah. Cerita akan disimpan secara lokal.');
            ...
            alert('Cerita disimpan ke penyimpanan lokal.');
            location.hash = '#/';
        }
    });
